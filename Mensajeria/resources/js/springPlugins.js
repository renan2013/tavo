...
function printGrid(rows,formMante,formDelete){
        ...
        if(comportamiento === "P" || comportamiento === "C"){
            var encabezados = $("#GRID thead tr");
            //console.log(encabezados.find( "th" ));
            var fristTh = $(encabezados.find( "th" )['0']);
            //console.log($(fristTh)['0'].childNodes);
            var th = encabezados;
           if ($(fristTh)['0'].childNodes.length > 0){
                th = "<th></th>"+encabezados.html();
               encabezados.html(th);
               $("#GRID tfoot tr").html(th);
           }
        }
        ...
        for(i in rows){
          ...
          if(comportamiento === "P"){
            tempComportamiento = '"'+comportamiento+'"';
            tableRows += "<td><input type='radio' name='selected' onclick='selectRow(" +i+","+tempComportamiento+")' class=''/> </td>";
            
          }
          
          if(comportamiento === "C"){
            tempComportamiento = '"'+comportamiento+'"';
            tableRows += "<td><input type='checkbox' name='selected' onclick='selectRow(" +i+","+tempComportamiento+",this)' class=''/> </td>";
