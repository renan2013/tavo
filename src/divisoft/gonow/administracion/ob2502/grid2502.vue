...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2502.columnDefs;
        var defaultdatos = datos2502.datosDefault;
 ...
 filas.push({ NOMBRE: "NOM_GETILICIO", VALOR1: "", VALOR2: "", CDATA: "0" }); 
