...
<template>
  <div>
   ...
   <table class="table">   
     ...
     <filtrosDivisoft v-show="activaFiltro" :header="locallastheader"  :isSidebarActive="activaFiltro" :filas="locallaststrFilas" :filtros="filtros"  ObjectID=2503   @closeSidebar="activaFiltro = false" 
...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2503.columnDefs;
        var defaultdatos = datos2503.datosDefault;
 ...
 filas.push({ NOMBRE: "(select  Z.NOM_PAIS from GO_PAISES Z where  Z.COD_PAIS= A.COD_PAIS)  AS  NOM_PAIS", VALOR1: "", VALOR2: "", CDATA: "0" }); 
