      ...
      <vx-input-group class="mb-base">
        <div class="vx-row">
          ...
          <div class="vx-col w-1/2">
            ...
            <span class="text-danger">{{errors.first("step-1.DES_MONEDA")}}</span>
          </div>
          <div class="vx-col w-1/2">
            <vs-input
              size="large"
            ...
            <span class="text-danger">{{errors.first("step-1.DES_PAIS")}}</span>
          </div>
        </div>
        <button type="submit" class="btn btn-success" @click="GuardaRegistro()">Salvar Datos</button>
      </vx-input-group>
    </VuePerfectScrollbar>
  </vx-card>
</template> 
...
const dict = datos2507.mensajesValidacion;
...
export default {
  ...
  beforeMount() {
    ...
    this.defaultdatos = datos2507.datosDefault;
  ...
  data() {
    return {
      ...
      // CMSDATA2507: datos2507.CMSDATA2507,  PROPSDataCMS: divilib.DataCMS,  tituloAvatar: "Para Cambiar Avatar",  verDocumento1: false,
  ...
  methods: {
    ...
    addFilas: function() {
      ...
      filas.push({
        NOMBRE: "DES_MONEDA",
        VALOR1: this.DES_MONEDA,
        VALOR2: "",
        CDATA: "0"
      });
      filas.push({
        NOMBRE: "DES_PAIS",
        VALOR1: this.DES_PAIS,
        VALOR2: "",
        CDATA: "0"
      });
    ...
    cargaRegistroActual: function(datosRow) {
      ...
      this.DES_MONEDA = datosRow.DES_MONEDA;
      this.DES_PAIS = datosRow.DES_PAIS;
    ...
    buscarRegistro: function(dinamicKey) {
      ...
      var origenUrl = "O";
      // agrego las filas
      var filas = datos2507.getMisFilas();
