...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2508.columnDefs;
        var defaultdatos = datos2508.datosDefault;
 ...
 this.dinamicKey.push({ nombre: "COD_PAIS", valor: event.node.data.COD_PAIS });
 this.dinamicKey.push({ nombre: "COD_PROVINCIA", valor: event.node.data.COD_PROVINCIA });
 this.dinamicKey.push({ nombre: "COD_CANTON", valor: event.node.data.COD_CANTON });
 this.dinamicKey.push({ nombre: "COD_DISTRITO", valor: event.node.data.COD_DISTRITO });
 this.dinamicKey.push({ nombre: "COD_CASERIO", valor: event.node.data.COD_CASERIO });
 ...
 filas.push({ NOMBRE: "COD_CASERIO", VALOR1: "", VALOR2: "", CDATA: "0" }); 
  ...
  this.dinamicKey.push({ nombre: "COD_PAIS", valor: "0" }); 
  this.dinamicKey.push({ nombre: "COD_PROVINCIA", valor: "0" }); 
  this.dinamicKey.push({ nombre: "COD_CANTON", valor: "0" }); 
  this.dinamicKey.push({ nombre: "COD_DISTRITO", valor: "0" }); 
  this.dinamicKey.push({ nombre: "COD_CASERIO", valor: "0" }); 
   //llama método editar registro
            eventBus.$emit("cargaRegistro", this.dinamicKey);
