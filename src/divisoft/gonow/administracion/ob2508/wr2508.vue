...
<template>
    <div id="avatar-2508">  
        <grid2508 v-show="!activaEdit"></grid2508>  
        <Edit2508 v-show="activaEdit && !activaPromp"  :key2="editKey"  :datosEdit="datosEdit"  @closeSidebar="activaEdit = false"  />   
...
import grid2508 from "./grid2508.vue"  
import Edit2508 from "./Edit2508.vue"
...
import * as datos2508 from  "./js/divi2508.js"; 
export default{
    components: { 
        grid2508, 
        Edit2508,
  ...
  methods: { 
       ...
       cargaPrompt2501(filtrosParam2501)
        {
          var filas=[];
 filas.push(  { NOMBRE: "COD_ZONA", VALOR1: "", VALOR2: "", CDATA: "0" });
   ...
   this.datosPrompt=[];
   this.datosPrompt=[  {titulo:"GO_ZONAS",ObjectId:2501,idprompt:1, filas:[], datos:[]}];

   this.datosPrompt[0].datos=filtrosParam2501;
   ...
   var columnDefs = [
        ...
        this.datosPrompt[0].columnDefs=columnDefs; 
          ...
          //console.log("padre cargaPrompt2501,",filtrosParam2501);
        this.promptKey++; 
        this.editKey++;
 ...
 filas.push(  { NOMBRE: "COD_PAIS", VALOR1: "", VALOR2: "", CDATA: "0" });
   ...
   this.datosPrompt=[];
   this.datosPrompt=[  {titulo:"GO_PAISES",ObjectId:2502,idprompt:2, filas:[], datos:[]}];
 ...
 filas.push(  { NOMBRE: "COD_PAIS", VALOR1: "", VALOR2: "", CDATA: "0" });
   ...
   this.datosPrompt=[];
   this.datosPrompt=[  {titulo:"GO_PROVINCIAS",ObjectId:2503,idprompt:3, filas:[], datos:[]}];
   ...
   var columnDefs = [
       ...
       cargaPrompt2504(filtrosParam2504)
        {
          var filas=[];
 filas.push(  { NOMBRE: "COD_PAIS", VALOR1: "", VALOR2: "", CDATA: "0" });
                             filas.push(  { NOMBRE: "COD_PROVINCIA", VALOR1: "", VALOR2: "", CDATA: "0" });
                             filas.push(  { NOMBRE: "COD_CANTON", VALOR1: "", VALOR2: "", CDATA: "0" });
                             filas.push(  { NOMBRE: "DES_CANTON", VALOR1: "", VALOR2: "", CDATA: "0" });
                             
   this.datosPrompt=[];
   this.datosPrompt=[  {titulo:"GO_CANTONES",ObjectId:2504,idprompt:4, filas:[], datos:[]}];

   this.datosPrompt[0].datos=filtrosParam2504;
   this.datosPrompt[0].filas=filas;
   ...
   var columnDefs = [
        ...
        this.datosPrompt[0].columnDefs=columnDefs; 
          ...
          //console.log("padre cargaPrompt2504,",filtrosParam2504);
        this.promptKey++; 
        this.editKey++;
        this.activaPromp=true;
       ...
       cargaPrompt2505(filtrosParam2505)
        {
          var filas=[];
 filas.push(  { NOMBRE: "COD_PAIS", VALOR1: "", VALOR2: "", CDATA: "0" });
                             filas.push(  { NOMBRE: "COD_PROVINCIA", VALOR1: "", VALOR2: "", CDATA: "0" });
                             filas.push(  { NOMBRE: "COD_CANTON", VALOR1: "", VALOR2: "", CDATA: "0" });
                             filas.push(  { NOMBRE: "COD_DISTRITO", VALOR1: "", VALOR2: "", CDATA: "0" });
                             filas.push(  { NOMBRE: "DES_DISTRITO", VALOR1: "", VALOR2: "", CDATA: "0" });
                             
   this.datosPrompt=[];
   this.datosPrompt=[  {titulo:"GO_DISTRITOS",ObjectId:2505,idprompt:5, filas:[], datos:[]}];

   this.datosPrompt[0].datos=filtrosParam2505;
   this.datosPrompt[0].filas=filas;
   ...
   var columnDefs = [
        ...
        this.datosPrompt[0].columnDefs=columnDefs; 
          ...
          //console.log("padre cargaPrompt2505,",filtrosParam2505);
        this.promptKey++; 
        this.editKey++;
        this.activaPromp=true;
       ...
       cargaPrompt2506(filtrosParam2506)
        {
          var filas=[];
 filas.push(  { NOMBRE: "COD_PAIS", VALOR1: "", VALOR2: "", CDATA: "0" });
                             filas.push(  { NOMBRE: "COD_PROVINCIA", VALOR1: "", VALOR2: "", CDATA: "0" });
                             filas.push(  { NOMBRE: "COD_CANTON", VALOR1: "", VALOR2: "", CDATA: "0" });
                             filas.push(  { NOMBRE: "COD_DISTRITO", VALOR1: "", VALOR2: "", CDATA: "0" });
                             filas.push(  { NOMBRE: "COD_CASERIO", VALOR1: "", VALOR2: "", CDATA: "0" });
                             filas.push(  { NOMBRE: "DES_CASERIO", VALOR1: "", VALOR2: "", CDATA: "0" });
                             
   this.datosPrompt=[];
   this.datosPrompt=[  {titulo:"GO_CASERIO",ObjectId:2506,idprompt:6, filas:[], datos:[]}];

   this.datosPrompt[0].datos=filtrosParam2506;
   this.datosPrompt[0].filas=filas;
   ...
   var columnDefs = [
        ...
        this.datosPrompt[0].columnDefs=columnDefs; 
          ...
          //console.log("padre cargaPrompt2506,",filtrosParam2506);
        this.promptKey++; 
        this.editKey++;
        this.activaPromp=true;
