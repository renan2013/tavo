...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2511.columnDefs;
        var defaultdatos = datos2511.datosDefault;
    ...
    methods: {
        ...
        onDoubleClicked(event) {
            ...
            this.dinamicKey = [];
 this.dinamicKey.push({ nombre: "COD_PERSONA", valor: event.node.data.COD_PERSONA });
 this.dinamicKey.push({ nombre: "COD_CIA", valor: event.node.data.COD_CIA });
 ...
 filas.push({ NOMBRE: "DI_DIRECCION", VALOR1: "", VALOR2: "", CDATA: "0" }); 
        ...
        //LLAMA AL COMPONENTE EDIT PARA  AGREGAR UN REGISTRO NUEVO
         // RegistroNuevo Gen_CAMPOS_GRID(3)
            RegistroNuevo() {
                    ...
                    this.$store.commit("MUTSETDATOSDEFAULT", defaultdatos);
                    //LLAVES
  this.dinamicKey.push({ nombre: "COD_PERSONA", valor: "0" }); 
  this.dinamicKey.push({ nombre: "COD_CIA", valor: "0" }); 
   //llama método editar registro
            eventBus.$emit("cargaRegistro", this.dinamicKey);
