        ...
        <div class="vx-row">
          <div class="vx-col w-1/2">
            ...
            <span class="text-danger">{{
              errors.first("step-1.COD_TARJETA")
            }}</span>
          </div>
          <div class="vx-col w-1/2">
            <vs-input
            ...
            <span class="text-danger">{{
              errors.first("step-1.DES_TARJETA")
            }}</span>
          </div>
          <div class="vx-col md:w-1/2 w-full">
            <ul class="centerx">
              <li :key="index" v-for="(item, index) in LI_ESTADOS">
                <vs-radio v-model="IND_ESTADO" :vs-value="item.value">{{
                  item.text
                }}</vs-radio>
              </li>
            </ul>
...
const dict = datos2514.mensajesValidacion;
...
export default {
  ...
  beforeMount() {
    ...
    this.defaultdatos = datos2514.datosDefault;
  ...
  data() {
    return {
      ...
      // CMSDATA2514: datos2514.CMSDATA2514,  PROPSDataCMS: divilib.DataCMS,  tituloAvatar: "Para Cambiar Avatar",  verDocumento1: false,
      ...
      LI_ESTADOS: datos2514.LI_ESTADOS,
  ...
  methods: {
    ...
    addFilas: function() {
      ...
      filas.push({
        NOMBRE: "COD_TARJETA",
        VALOR1: this.COD_TARJETA,
        VALOR2: "",
        CDATA: "0"
      });
      filas.push({
        NOMBRE: "DES_TARJETA",
        VALOR1: this.DES_TARJETA,
        VALOR2: "",
        CDATA: "0"
      });
      filas.push({
    ...
    cargaRegistroActual: function(datosRow) {
      this.COD_TARJETA = datosRow.COD_TARJETA;
      this.DES_TARJETA = datosRow.DES_TARJETA;
    ...
    buscarRegistro: function(dinamicKey) {
      ...
      var origenUrl = "O";
      // agrego las filas
      var filas = datos2514.getMisFilas();
