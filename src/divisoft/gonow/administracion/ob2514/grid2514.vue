...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2514.columnDefs;
        var defaultdatos = datos2514.datosDefault;
    ...
    methods: {
        ...
        onDoubleClicked(event) {
            ...
            this.dinamicKey = [];
 this.dinamicKey.push({ nombre: "COD_TARJETA", valor: event.node.data.COD_TARJETA });
      ...
      // addFilas Gen_CAMPOS_GRID(1)
            addFilas: function() {
            var filas = [];
 filas.push({ NOMBRE: "COD_TARJETA", VALOR1: "", VALOR2: "", CDATA: "0" }); 
 filas.push({ NOMBRE: "DES_TARJETA", VALOR1: "", VALOR2: "", CDATA: "0" }); 
        ...
        //LLAMA AL COMPONENTE EDIT PARA  AGREGAR UN REGISTRO NUEVO
         // RegistroNuevo Gen_CAMPOS_GRID(3)
            RegistroNuevo() {
                    ...
                    this.$store.commit("MUTSETDATOSDEFAULT", defaultdatos);
                    //LLAVES
  this.dinamicKey.push({ nombre: "COD_TARJETA", valor: "0" }); 
   //llama método editar registro
            eventBus.$emit("cargaRegistro", this.dinamicKey);
