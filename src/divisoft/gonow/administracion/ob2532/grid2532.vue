...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2532.columnDefs;
        var defaultdatos = datos2532.datosDefault;
 ...
 filas.push({ NOMBRE: "DES_TRANSPORTE", VALOR1: "", VALOR2: "", CDATA: "0" }); 
