            ...
            <div class="vx-row"> 
                   ...
                   <div class="vx-col w-full">
                               <vx-input-group class="mb-base">
                                ...
                                <template slot="prepend">
                                  <vs-input
                                    :value="NUM_RANGOVOLUMEN"
                                    v-model="NUM_RANGOVOLUMEN"
                                    name="NUM_RANGOVOLUMEN"
                                    label="Número Rangovolumen"
                                  />
                                  
                                  <vs-button
                                    color="primary"
                                    type="border"
                                    @click="setActivaPromp2534"
                                    >IR</vs-button
                                  >
                                  
                                  <vs-input
                                    :value="DI_RANGOVLUMEN"
                                    v-model="DI_RANGOVLUMEN"
                                    name="DI_RANGOVLUMEN"
                                    label="Nombre"
                                  />
                   ...
                   <div class="vx-col w-full">
                               <vx-input-group class="mb-base">
                                ...
                                <template slot="prepend">
                                  <vs-input
                                    :value="NUM_TRANSPORTE"
                                    v-model="NUM_TRANSPORTE"
                                    name="NUM_TRANSPORTE"
                                  ...
                                  <vs-button
                                    color="primary"
                                    type="border"
                                    @click="setActivaPromp2532"
                                    >IR</vs-button
                                  >
                                  
                                  <vs-input
                                    :value="DI_TRANSPORTE"
                                    v-model="DI_TRANSPORTE"
                                    name="DI_TRANSPORTE"
                                    label="Nombre"
                                  />
...
import * as datos2533 from "./js/divi2533.js";
...
const dict = datos2533.mensajesValidacion;
...
export default {
  ...
  beforeMount() {
    ...
    this.defaultdatos = datos2533.datosDefault;
  ...
  watch: { 
    // SI HAY PROMPT
      ...
      this.NUM_RANGOVOLUMEN = this.rowselectionprompt.NUM_RANGOVOLUMEN;
      this.DI_RANGOVLUMEN = this.rowselectionprompt.DES_RANGOVOLUMEN;
  }
                                                 if (this.indicadorPrompt == 2) {
                                 
      this.NUM_TRANSPORTE = this.rowselectionprompt.NUM_TRANSPORTE;
      this.DI_TRANSPORTE = this.rowselectionprompt.DES_TRANSPORTE;
  }
  ...
  data() {
    return {
      ...
      // CMS CMS CMS CMS          DatOS cms Para manejo de EXPEDIENTE DIGITAL  MULTIMEDIA Debe venir en una funcion de Datos con la consulta
        // CMSDATA2533: datos2533.CMSDATA2533,  PROPSDataCMS: divilib.DataCMS,  tituloAvatar: "Para Cambiar Avatar",  verDocumento1: false,
  ...
  methods: {
    ...
    setActivaPromp2534() {  //GO_RANGOVOLUMEN
      var filtros2534 = [  
        { nombre: "nombre", valor:""},];

      this.$parent.cargaPrompt2534(filtros2534);
    }, 
           // METODO QUE CARGA LOS DATOS DEL FILTRO PARA LOS PROMPT  CARGA LOS DATOS DE FILTRO
    setActivaPromp2532() {  //GO_TIPOTRANSPORTE
      var filtros2532 = [  
        { nombre: "nombre", valor:""},];

      this.$parent.cargaPrompt2532(filtros2532);
    }, 
 ...
 validateStep3() {
    ...
    // CARGA DE una variable Bd a DOM
     cargaRegistroActual: function(datosRow) { 
          ...
          this.NUM_TRANSPORTE = datosRow.NUM_TRANSPORTE;
          this.IND_ESTADO = datosRow.IND_ESTADO;
          this.DI_TRANSPORTE = datosRow.DI_TRANSPORTE;
          this.DI_RANGOVLUMEN = datosRow.DI_RANGOVLUMEN;
   ...
   //cargaRegistroActual funcion completa   
    ...
    buscarRegistro: function(dinamicKey) {
      ...
      var origenUrl = "O";
       // agrego las filas
         var filas = datos2533.getMisFilas();
