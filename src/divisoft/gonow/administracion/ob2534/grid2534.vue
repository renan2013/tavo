...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2534.columnDefs;
        var defaultdatos = datos2534.datosDefault;
 ...
 filas.push({ NOMBRE: "DES_RANGOVOLUMEN", VALOR1: "", VALOR2: "", CDATA: "0" }); 
