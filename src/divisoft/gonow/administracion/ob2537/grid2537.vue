...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2537.columnDefs;
        var defaultdatos = datos2537.datosDefault;
    ...
    methods: {
        ...
        onDoubleClicked(event) {
            ...
            this.dinamicKey = [];
 this.dinamicKey.push({ nombre: "COD_CATEGORIAMENSAJERO", valor: event.node.data.COD_CATEGORIAMENSAJERO });
      ...
      // addFilas Gen_CAMPOS_GRID(1)
            addFilas: function() {
            var filas = [];
 filas.push({ NOMBRE: "COD_CATEGORIAMENSAJERO", VALOR1: "", VALOR2: "", CDATA: "0" }); 
 filas.push({ NOMBRE: "TIP_COMISIONMENSAJERO", VALOR1: "", VALOR2: "", CDATA: "0" }); 
 filas.push({ NOMBRE: "VALOR_COMISIONMENSAJERO", VALOR1: "", VALOR2: "", CDATA: "0" }); 
        ...
        //LLAMA AL COMPONENTE EDIT PARA  AGREGAR UN REGISTRO NUEVO
         // RegistroNuevo Gen_CAMPOS_GRID(3)
            RegistroNuevo() {
                    ...
                    this.$store.commit("MUTSETDATOSDEFAULT", defaultdatos);
                    //LLAVES
  this.dinamicKey.push({ nombre: "COD_CATEGORIAMENSAJERO", valor: "0" }); 
   //llama método editar registro
            eventBus.$emit("cargaRegistro", this.dinamicKey);
