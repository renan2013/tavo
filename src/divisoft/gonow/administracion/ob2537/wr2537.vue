...
<template>
    <div id="avatar-2537">  
        <grid2537 v-show="!activaEdit"></grid2537>  
        <Edit2537 v-show="activaEdit && !activaPromp"  :key2="editKey"  :datosEdit="datosEdit"  @closeSidebar="activaEdit = false"  />   
...
import grid2537 from "./grid2537.vue"  
import Edit2537 from "./Edit2537.vue"
