...
<template>
  <div>
   ...
   <table class="table">   
     ...
     <filtrosDivisoft v-show="activaFiltro" :header="locallastheader"  :isSidebarActive="activaFiltro" :filas="locallaststrFilas" :filtros="filtros"  ObjectID=2521   @closeSidebar="activaFiltro = false" 
...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2521.columnDefs;
        var defaultdatos = datos2521.datosDefault;
