...
<template>
    <div id="avatar-2524">  
        <grid2524 v-show="!activaEdit"></grid2524>  
        <Edit2524 v-show="activaEdit && !activaPromp"  :key2="editKey"  :datosEdit="datosEdit"  @closeSidebar="activaEdit = false"  />   
...
import grid2524 from "./grid2524.vue"  
import Edit2524 from "./Edit2524.vue"
