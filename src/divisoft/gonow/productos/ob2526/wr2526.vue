...
<template>
    <div id="avatar-2526">  
        <grid2526 v-show="!activaEdit"></grid2526>  
        <Edit2526 v-show="activaEdit && !activaPromp"  :key2="editKey"  :datosEdit="datosEdit"  @closeSidebar="activaEdit = false"  />   
...
import grid2526 from "./grid2526.vue"  
import Edit2526 from "./Edit2526.vue"
