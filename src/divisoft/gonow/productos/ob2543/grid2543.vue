...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2543.columnDefs;
        var defaultdatos = datos2543.datosDefault;
    ...
    methods: {
        ...
        onDoubleClicked(event) {
            ...
            this.dinamicKey = [];
 this.dinamicKey.push({ nombre: "COD_PATNER", valor: event.node.data.COD_PATNER });
 this.dinamicKey.push({ nombre: "COD_PRODUCTO", valor: event.node.data.COD_PRODUCTO });
 this.dinamicKey.push({ nombre: "COD_HASHTAG", valor: event.node.data.COD_HASHTAG });
 ...
 filas.push({ NOMBRE: "COD_HASHTAG", VALOR1: "", VALOR2: "", CDATA: "0" }); 
        ...
        //LLAMA AL COMPONENTE EDIT PARA  AGREGAR UN REGISTRO NUEVO
         // RegistroNuevo Gen_CAMPOS_GRID(3)
            RegistroNuevo() {
                    ...
                    this.$store.commit("MUTSETDATOSDEFAULT", defaultdatos);
                    //LLAVES
  this.dinamicKey.push({ nombre: "COD_PATNER", valor: "0" }); 
  this.dinamicKey.push({ nombre: "COD_PRODUCTO", valor: "0" }); 
  this.dinamicKey.push({ nombre: "COD_HASHTAG", valor: "0" }); 
   //llama método editar registro
            eventBus.$emit("cargaRegistro", this.dinamicKey);
