...
import grid2543 from "./grid2543.vue"  
import Edit2543 from "./Edit2543.vue"
...
export default{
 ...
 filas.push(  { NOMBRE: "COD_PATNER", VALOR1: "", VALOR2: "", CDATA: "0" });
   ...
   this.datosPrompt=[];
   this.datosPrompt=[  {titulo:"GO_PATNER",ObjectId:2520,idprompt:1, filas:[], datos:[]}];
 ...
 filas.push(  { NOMBRE: "COD_PATNER", VALOR1: "", VALOR2: "", CDATA: "0" });
   ...
   var columnDefs = [
       ...
       cargaPrompt2542(filtrosParam2542)
        {
          var filas=[];
 filas.push(  { NOMBRE: "COD_HASHTAG", VALOR1: "", VALOR2: "", CDATA: "0" });
                             filas.push(  { NOMBRE: "DES_HASHTAG", VALOR1: "", VALOR2: "", CDATA: "0" });
                             
   this.datosPrompt=[];
   this.datosPrompt=[  {titulo:"GO_HASHTAG",ObjectId:2542,idprompt:3, filas:[], datos:[]}];

   this.datosPrompt[0].datos=filtrosParam2542;
   this.datosPrompt[0].filas=filas;
                              
   var columnDefs = [
                                {
                     headerName: "Código Hashtag",
                     field: "COD_HASHTAG",
                      filter: true,
                      width: 200 
                  }, 
        ...
        this.datosPrompt[0].columnDefs=columnDefs; 
          ...
          //console.log("padre cargaPrompt2542,",filtrosParam2542);
        this.promptKey++; 
        this.editKey++;
        this.activaPromp=true;
