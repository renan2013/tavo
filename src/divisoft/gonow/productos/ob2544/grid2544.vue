...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2544.columnDefs;
        var defaultdatos = datos2544.datosDefault;
    ...
    methods: {
        ...
        onDoubleClicked(event) {
            ...
            this.dinamicKey = [];
 this.dinamicKey.push({ nombre: "COD_CATEGORIA", valor: event.node.data.COD_CATEGORIA });
 ...
 filas.push({ NOMBRE: "DI_PRODUCTO", VALOR1: "", VALOR2: "", CDATA: "0" }); 
        ...
        //LLAMA AL COMPONENTE EDIT PARA  AGREGAR UN REGISTRO NUEVO
         // RegistroNuevo Gen_CAMPOS_GRID(3)
            RegistroNuevo() {
                    ...
                    this.$store.commit("MUTSETDATOSDEFAULT", defaultdatos);
                    //LLAVES
  this.dinamicKey.push({ nombre: "COD_CATEGORIA", valor: "0" }); 
