...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2512.columnDefs;
        var defaultdatos = datos2512.datosDefault;
    ...
    methods: {
        ...
        onDoubleClicked(event) {
            ...
            this.dinamicKey = [];
 this.dinamicKey.push({ nombre: "COD_CATEGORIAPATNER", valor: event.node.data.COD_CATEGORIAPATNER });
      ...
      // addFilas Gen_CAMPOS_GRID(1)
            addFilas: function() {
            var filas = [];
 filas.push({ NOMBRE: "COD_CATEGORIAPATNER", VALOR1: "", VALOR2: "", CDATA: "0" }); 
 filas.push({ NOMBRE: "TIP_COMISIONPATNET", VALOR1: "", VALOR2: "", CDATA: "0" }); 
 filas.push({ NOMBRE: "VALOR_COMISIONPATNER", VALOR1: "", VALOR2: "", CDATA: "0" }); 
        ...
        //LLAMA AL COMPONENTE EDIT PARA  AGREGAR UN REGISTRO NUEVO
         // RegistroNuevo Gen_CAMPOS_GRID(3)
            RegistroNuevo() {
                    ...
                    this.$store.commit("MUTSETDATOSDEFAULT", defaultdatos);
                    //LLAVES
  this.dinamicKey.push({ nombre: "COD_CATEGORIAPATNER", valor: "0" }); 
   //llama método editar registro
            eventBus.$emit("cargaRegistro", this.dinamicKey);
