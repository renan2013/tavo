...
<template>
    <div id="avatar-2512">  
        <grid2512 v-show="!activaEdit"></grid2512>  
        <Edit2512 v-show="activaEdit && !activaPromp"  :key2="editKey"  :datosEdit="datosEdit"  @closeSidebar="activaEdit = false"  />   
...
import grid2512 from "./grid2512.vue"  
import Edit2512 from "./Edit2512.vue"
