...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2518.columnDefs;
        var defaultdatos = datos2518.datosDefault;
 ...
 this.dinamicKey.push({ nombre: "ID_TAX", valor: event.node.data.ID_TAX });
 ...
 filas.push({ NOMBRE: "DI_CIA", VALOR1: "", VALOR2: "", CDATA: "0" }); 
 ...
 filas.push({ NOMBRE: "NOM_TAX", VALOR1: "", VALOR2: "", CDATA: "0" }); 
  ...
  this.dinamicKey.push({ nombre: "ID_TAX", valor: "0" }); 
   //llama método editar registro
            eventBus.$emit("cargaRegistro", this.dinamicKey);
