...
import * as datos2520 from "./js/divi2520.js";
...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2520.columnDefs;
        var defaultdatos = datos2520.datosDefault;
 ...
 filas.push({ NOMBRE: "NUM_CALIFICACION", VALOR1: "", VALOR2: "", CDATA: "0" }); 
