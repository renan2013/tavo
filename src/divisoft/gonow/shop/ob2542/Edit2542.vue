    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new pt-4 pb-6"> 
        <vx-input-group class="mb-base">
            <div class="vx-row"> 
                                 ...
                                 <p>Cod Hashtag</p>
                                <vs-input size="large" name="COD_HASHTAG" v-model="COD_HASHTAG" class="mt-5 w-full" />
                                <span class="text-danger">{{errors.first("step-1.COD_HASHTAG")}}</span>
                              </div><div class="vx-col w-1/2">
      <p>Des Hashtag</p>
        <vs-input size="large" v-validate="'required'"   label="Des Hashtag" name="DES_HASHTAG" v-model="DES_HASHTAG" class="mt-5 w-full" />
         
        <span class="text-danger">{{errors.first("step-1.DES_HASHTAG")}}</span>
      </div> <div class="vx-col md:w-1/2 w-full">  
                                                     <vs-switch color="success"  v-model="IND_ESTADO">
                                                       <span slot="0">Inactivo</span>
                                                       <span slot="1">Activo</span>
                                                    </vs-switch> 
                                                  </div>    
            </div> 
...
const dict = datos2542.mensajesValidacion;
...
export default {
  ...
  beforeMount() {
    ...
    this.defaultdatos = datos2542.datosDefault;
  ...
  data() {
    return {
      ...
      // CMS CMS CMS CMS          DatOS cms Para manejo de EXPEDIENTE DIGITAL  MULTIMEDIA Debe venir en una funcion de Datos con la consulta
        // CMSDATA2542: datos2542.CMSDATA2542,  PROPSDataCMS: divilib.DataCMS,  tituloAvatar: "Para Cambiar Avatar",  verDocumento1: false,
 ...
 validateStep3() {
    ...
    // CARGA DE una variable Bd a DOM
     cargaRegistroActual: function(datosRow) { 
          ...
          this.DES_HASHTAG = datosRow.DES_HASHTAG;
   ...
   //cargaRegistroActual funcion completa   
    ...
    buscarRegistro: function(dinamicKey) {
      ...
      var origenUrl = "O";
       // agrego las filas
         var filas = datos2542.getMisFilas();
