...
<template>
    <div id="avatar-2532">  
        <grid2532 v-show="!activaEdit"></grid2532>  
        <Edit2532 v-show="activaEdit && !activaPromp"  :key2="editKey"  :datosEdit="datosEdit"  @closeSidebar="activaEdit = false"  />   
...
import grid2532 from "./grid2532.vue"  
import Edit2532 from "./Edit2532.vue"
