...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos2533.columnDefs;
        var defaultdatos = datos2533.datosDefault;
    ...
    methods: {
        ...
        onDoubleClicked(event) {
            ...
            this.dinamicKey = [];
 this.dinamicKey.push({ nombre: "NUM_RANGOVOLUMEN", valor: event.node.data.NUM_RANGOVOLUMEN });
 this.dinamicKey.push({ nombre: "NUM_TRANSPORTE", valor: event.node.data.NUM_TRANSPORTE });
      ...
      // addFilas Gen_CAMPOS_GRID(1)
            addFilas: function() {
            var filas = [];
 filas.push({ NOMBRE: "DI_RANGOVLUMEN", VALOR1: "", VALOR2: "", CDATA: "0" }); 
 filas.push({ NOMBRE: "NUM_RANGOVOLUMEN", VALOR1: "", VALOR2: "", CDATA: "0" }); 
 filas.push({ NOMBRE: "DI_TRANSPORTE", VALOR1: "", VALOR2: "", CDATA: "0" }); 
 filas.push({ NOMBRE: "NUM_TRANSPORTE", VALOR1: "", VALOR2: "", CDATA: "0" }); 
        ...
        //LLAMA AL COMPONENTE EDIT PARA  AGREGAR UN REGISTRO NUEVO
         // RegistroNuevo Gen_CAMPOS_GRID(3)
            RegistroNuevo() {
                    ...
                    this.$store.commit("MUTSETDATOSDEFAULT", defaultdatos);
                    //LLAVES
  this.dinamicKey.push({ nombre: "NUM_RANGOVOLUMEN", valor: "0" }); 
  this.dinamicKey.push({ nombre: "NUM_TRANSPORTE", valor: "0" }); 
   //llama método editar registro
            eventBus.$emit("cargaRegistro", this.dinamicKey);
