...
<div>
    <div v-if="isNinja" id="GRID2503">
        ...
        <filtrosDivisoft v-show="activaFiltro" :header="locallastheader" :isSidebarActive="activaFiltro" :filas="locallaststrFilas" :filtros="filtros" ObjectID=2503 @closeSidebar="activaFiltro = false" @ajustaUltimoParam="ajustaUltimoParam" />
        <!-- TABLE ACTION ROW -->
    ...
    methods: {
        ...
        onDoubleClicked(event) {
            ...
            this.dinamicKey.push({
                nombre: "COD_PAIS",
                valor: event.node.data.COD_PAIS
            });
            this.dinamicKey.push({
                nombre: "COD_PROVINCIA",
                valor: event.node.data.COD_PROVINCIA
            });
