...
<template>
    <div id="avatar-2509">  
        <grid2509 v-show="!activaEdit"></grid2509>  
        <Edit2509 v-show="activaEdit && !activaPromp"  :key2="editKey"  :datosEdit="datosEdit"  @closeSidebar="activaEdit = false"  />   
...
import grid2509 from "./grid2509.vue"  
import Edit2509 from "./Edit2509.vue"
