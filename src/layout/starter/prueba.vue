            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                ...
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link" data-toggle="dropdown" role="button">
                        ...
                        <span class="nav-link-inner--text">CEFI Academy</span>
                    </a>
                    <div class="dropdown-menu">
                        <router-link to="/landing" class="dropdown-item">CEFI - Virtual</router-link>
                        <router-link to="/profile" class="dropdown-item">Clases</router-link>
